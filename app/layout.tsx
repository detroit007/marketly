      ...
      <body className={inter.className+ "bg-white"}>
          {children}
				<footer className='px-auto'>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 my-24 container mx-auto items-center">
						<div className="col-span-1"><img alt="logo"
								src="./Dine Market_files/Logo.png" width="180" height="30" decoding="async"
					...
					<div className=" flex justify-around py-8 border-t border-grey">
